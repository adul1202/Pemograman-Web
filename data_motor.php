        ...
        <li>
          ...
          <ul class="treeview-menu">
              ...
              <li class="treeview">
                  ...
                  <li class="treeview">
                    <a href="tambah_pembeli.php"><i class="fa fa-users"></i><span>Pembeli</span>
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
                    </a>
    ...
    <!-- Content Header (Page header) -->
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Data Motor</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-stripped">
            ...
            <tbody>
              <?php  
              $no = 1;
              $result = mysqli_query($konek, "SELECT * FROM tb_motor");
                while($user_data = mysqli_fetch_array($result)) {  ?>       
                  
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $user_data['merek_motor'] ?></td>
                  <td><?php echo $user_data['jenis_motor'] ?></td>
                  <td><?php echo $user_data['harga'] ?></td>
                  <td>
                    <a href="edit_motor.php?id_motor=<?php echo $user_data['id_motor']; ?>" class="btn btn-success btn-small" title="Edit Data Motor"><i class="fa fa-edit"></i>Edit</a>
                    <a href="delete_motor.php?id_motor=<?php echo $user_data['id_motor']; ?>" class="btn btn-danger btn-small" title="Delete Data" onclick="return confirm('Apakah anda yankin ingin menghapus Data ini gblk??')" ><i class="fa fa-trash"></i>Delete</a>
                  </td>
