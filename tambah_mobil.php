...
<div class="wrapper">
          ...
          <ul class="treeview-menu">
              ...
              <li class="treeview">
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-plus"></i>Tambah Motor</a></li>
        ...
        <form class="form-horizontal" action="" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="merk_mobil" placeholder="Merek Mobil" required="">
              </div>
            </div>
            <div class="form-group">
              ...
              <select class="form-control" name="jenis_mobil">
                <option disabled selected class="form-control">Pilih Jenis Mobil</option>
  ...
  if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($konek, "INSERT INTO tb_mobil(id_mobil,merk_mobil,jenis_mobil,harga) VALUES('','$merk_mobil','$jenis_mobil','$harga')");
