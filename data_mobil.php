        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-stripped">
            ...
            <tbody>
              <?php  
              $no = 1;
              $result = mysqli_query($konek, "SELECT * FROM tb_mobil");
                while($user_data = mysqli_fetch_array($result)) {  ?>       
                  
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $user_data['merk_mobil'] ?></td>
                  <td><?php echo $user_data['jenis_mobil'] ?></td>
                  <td><?php echo $user_data['harga'] ?></td>
                  <td>
                    <a href="edit_mobil.php?id_mobil=<?php echo $user_data['id_mobil']; ?>" class="btn btn-success btn-small" title="Edit Data Mobil"><i class="fa fa-edit"></i>Edit</a>
                    <a href="delete_mobil.php?id_mobil=<?php echo $user_data['id_mobil']; ?>" class="btn btn-danger btn-small" title="Delete Data" onclick="return confirm('Apakah anda yankin ingin menghapus Data ini gblk??')" ><i class="fa fa-trash"></i>Delete</a>
                  </td>
