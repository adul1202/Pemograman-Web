...
<div class="wrapper">
        ...
        <form class="form-horizontal" action="" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="merek_motor" placeholder="Merek Motor" required="">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" >Jenis Motor</label>
              <div class="col-sm-10">
              <select class="form-control" name="jenis_motor">
                <option disabled selected class="form-control">Pilih Jenis Motor</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="number" name="harga_motor" class="form-control"  placeholder="Harga" required="">
              </div>
            </div>
          </div>
  ...
  if(isset($_POST['submit'])) {
    $merek = $_POST['merek_motor'];
    $jenis = $_POST['jenis_motor'];
    $harga = $_POST['harga_motor'];
    
    
    $result = mysqli_query($konek, "INSERT INTO tb_motor(id_motor,merek_motor,jenis_motor,harga_motor) VALUES('','$merek','$jenis','$harga')");
