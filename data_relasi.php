  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="data_relasi.php"><i class="fa fa-th"></i> <span>Data Relasi</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-stripped">
            ...
            <tbody>
              <tr>
              <?php
                $view = mysqli_query($konek, "SELECT * FROM tampil 
                  INNER JOIN tb_mobil on tampil.id_mobil = tb_mobil.id_mobil
                  INNER JOIN tb_motor on tampil.id_motor = tb_motor.id_motor
                  INNER JOIN tb_pembeli on tampil.id_pembeli = tb_pembeli.id_pembeli
                   ");
                while($data = mysqli_fetch_array($view)) {  ?>       
                  ...
                  <th><?php echo $data['no_telp'] ?></th>
                  <th><?php echo $data['jenis_mobil'] ?></th>
                  <th><?php echo $data['jenis_motor'] ?></th>
                  <th><?php echo $data['harga_motor'] ?></th>  
