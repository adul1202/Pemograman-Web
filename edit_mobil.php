...
$id = $_GET['id_mobil'];
$view = mysqli_query($konek, "SELECT * FROM tb_mobil WHERE id_mobil='$id'");
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview"><a href="data_relasi.php"><i class="fa fa-th"></i> <span>Data Relasi</span></a></li><li class="active treeview"><a href="data_relasi.php"><i class="fa fa-th"></i> <span>Data Relasi</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
      ...
      <div class="box-body">
        <form class="form-horizontal" action="" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Merek Mobil</label>

              <div class="col-sm-10">
                <input type="text" class="form-control" name="merk_mobil" placeholder="Merek Mobil" required="" value="<?php echo $data['merk_mobil'] ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" >Jenis Mobil</label>
              <div class="col-sm-10">
              <select class="form-control" name="jenis_mobil" value="">
                <option disabled selected class="form-control"><?php echo $data['jenis_mobil'] ?></option>
                <option class="form-control" value="YAMAHA">Yamaha</option>
                <option class="form-control" value="HONDA">Honda</option>
                <option class="form-control" value="BMW">BMW</option>
                <option class="form-control" value="FERARRI">FERRARI</option>
              </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="number" name="harga" class="form-control"  placeholder="Harga" required="" value="<?php echo $data['harga'] ?>">
              </div>
            </div>
          </div>
  ...
  if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($konek, "UPDATE tb_mobil SET merk_mobil='$merk_mobil', jenis_mobil='$jenis_mobil', harga='$harga' WHERE id_mobil='$id'");
    
    if( $result ) {
        echo "<div align='center'><h4> Data Berhasil Di Update </h4> </div>";
        echo "<meta http-equiv='refresh' content='1;url=http://localhost/pwl/data_mobil.php'>";
    } else {
