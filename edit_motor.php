...
$id = $_GET['id_motor'];
$view = mysqli_query($konek, "SELECT * FROM tb_motor WHERE id_motor='$id'");
...
<div class="wrapper">
          ...
          <ul class="treeview-menu">
              ...
              <li class="treeview">
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="tambah_pembeli"><i class="fa fa-plus"></i>Tambah Pembeli</a></li>
      ...
      <div class="box-body">
        <form class="form-horizontal" action="" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Merek Motor</label>

              <div class="col-sm-10">
                <input type="text" class="form-control" name="merek_motor" placeholder="Merek Motor" required="" value="<?php echo $data['merek_motor'] ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" >Jenis Motor</label>
              <div class="col-sm-10">
              <select class="form-control" name="jenis_motor" value="">
                <option disabled selected class="form-control"><?php echo $data['jenis_motor'] ?></option>
                <option class="form-control" value="YAMAHA">Yamaha</option>
                <option class="form-control" value="HONDA">Honda</option>
                <option class="form-control" value="KAWASAKI">KAWASAKI</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="number" name="harga" class="form-control"  placeholder="Harga" required="" value="<?php echo $data['harga_motor'] ?>">
              </div>
            </div>
          </div>
  ...
  if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($konek, "UPDATE tb_motor SET merek_motor='$merek_motor', jenis_motor='$jenis_motor', harga_motor='$harga' WHERE id_motor='$id'");
    
    if( $result ) {
      echo "<div align='center'><h4> Data Berhasil Di Update </h4> </div>";
        echo "<meta http-equiv='refresh' content='1;url=http://localhost/pwl/data_motor.php'>";
    } else {
