...
<div class="wrapper">
        ...
        <form class="form-horizontal" action="" method="POST">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="nama_pembeli" placeholder="Nama Lengkap" required="">
              </div>
            </div>
            <div class="form-group">
  ...
  if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($konek, "INSERT INTO tb_pembeli(id_pembeli,nama_pembeli,umur,no_telp) VALUES('','$nama','$umur','$notlp')");
